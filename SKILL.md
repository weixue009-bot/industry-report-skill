...
一次拉了 20 篇即可，不需要分类——目的是看标题和摘要来发现环节。
  ...
  "segments": [
    {
      ...
      "international_landscape": "国际竞争格局：海外龙头企业及市占率、技术路线差异",
      "domestic_landscape": "国内竞争格局：国内主要参与者和进展、国产化率",
      "product_tiers": [
...
| `scripts/build_report.py` | JSON 数据注入 HTML 模板，生成最终报告 |
| `templates/report.html` | 自包含 HTML 模板（CSS + JS 渲染） |
